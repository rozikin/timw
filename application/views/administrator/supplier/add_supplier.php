                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="supplier_name" placeholder="name" onfocus="" required>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group">
                                    <label>Supplier Address</label>
                                    <textarea class="form-control" rows="3" name="supplier_address" placeholder="Enter Address ..."></textarea>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control rounded-0" name="supplier_phone" id="supplier_phone" placeholder="phone" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="supplier_attention" placeholder="supplier_attention">
                                </div>
                                <div class=" form-group">
