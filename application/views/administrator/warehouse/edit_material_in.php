                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="text-center">
                            <h5 class="font-weight-bold"> Edit Material IN</h5>
                        </div>
                        <!-- title row -->

                        <!-- info row -->
                        <?= form_open_multipart('Controller_Warehouse/updates'); ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group row mb-1">
                                            <label for="id_in" class="col-sm-4 col-form-label">NO SJ</label>
                                            <div class="col-sm-5">
                                                <input type="hidden" class="form-control form-control-sm" id="id_in" name="id_in" value="<?= $po['id_in'] ?>" required autofocus>

                                                <input type="text" class="form-control form-control-sm" id="no_sj" name="no_sj" value="<?= $po['no_sj'] ?>" required autofocus>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date input-group-sm" id="reservationdatetime" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#reservationdatetime" name="date_in" value="<?= $po['request_date'] ?>" id="request_date" required />
                                        ...
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="po_no" name="po_no" value="<?= $po['po_no'] ?>" readonly autofocus>
                                            </div>
                                        </div>

                                        <div class="form-group row mb-1">
                                            <label for="id_supplier" class="col-sm-4 col-form-label">Supplier Name</label>
                                            <div class="col-sm-5">

                                                <input type="text" class="form-control form-control-sm" id="supplier_name" name="supplier_name" placeholder="Supplier Detail" value="<?= $po['supplier_name'] ?>" readonly>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control form-control-sm" id="kurir" name="kurir" value="<?= $po['kurir'] ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                                            <label for="ekspedisi" class="col-sm-4 col-form-label">Ekspedisi</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control form-control-sm" id="ekspedisi" name="ekspedisi" value="<?= $po['ekspedisi'] ?>" placeholder="apllication name" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                                            <label for="remark" class="col-sm-4 col-form-label">Remark</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control form-control-sm" id="remark" name="remark1" value="<?= $po['remark'] ?>" placeholder="apllication name" required>
                                            </div>
                                        </div>
