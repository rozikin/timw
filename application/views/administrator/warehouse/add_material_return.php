                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="text-center">
                            <h5 class="font-weight-bold"> Material Return</h5>
                        </div>
                        <!-- title row -->

                        <!-- info row -->
                        <?= form_open_multipart('Controller_Warehouse/create_return'); ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group row mb-1">
                                            <label for="no_sj" class="col-sm-4 col-form-label">NO Return</label>
                                            <div class="col-sm-5">

                                                <input type="hidden" class="form-control form-control-sm" id="id_return" name="id_return" required>
                                                <input type="text" class="form-control form-control-sm" id="no_return" name="no_return" required autofocus>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date input-group-sm" id="reservationdatetime" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#reservationdatetime" name="date_return" id="date_return" required />
                                        ...
                                        <div class=" form-group row mb-1">
                                            <label for="allocation" class="col-sm-4 col-form-label">Person</label>
                                            <div class="col-sm-5">
                        ...
                        <table id="example3" class="table table-hover table-bordered table-sm">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($item as $sm) : ?>
                                    <tr class="pilih_code_c1" data-id="<?= $sm['id_item'] ?>" data-kode="<?= $sm['item_code'] ?>" data-nama="<?= $sm['item_description'] ?>" data-size="<?= $sm['size'] ?>" data-color="<?= $sm['color'] ?>" data-qty="<?= $sm['qty'] ?>">
                                        <th scope="row"><?= $i; ?></th>
                                        <td><?= $sm['item_code']; ?></td>
