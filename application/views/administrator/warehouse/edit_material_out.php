                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="text-center">
                            <h5 class="font-weight-bold"> Edit Material OUT</h5>
                        </div>
                        <!-- title row -->

                        <!-- info row -->
                        <?= form_open_multipart('Controller_Warehouse/updates_out'); ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group row mb-1">
                                            <label for="id_in" class="col-sm-4 col-form-label">NO OUT</label>
                                            <div class="col-sm-5">
                                                <input type="hidden" class="form-control form-control-sm" id="id_out" name="id_out" value="<?= $po['id_out'] ?>" required autofocus>

                                                <input type="text" class="form-control form-control-sm" id="no_out" name="no_out" value="<?= $po['no_out'] ?>" required autofocus>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date input-group-sm" id="reservationdatetime" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#reservationdatetime" name="date_out" value="<?= $po['date_out'] ?>" id="date_out" required />
                                        ...
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="allocation" name="allocation" value="<?= $po['allocation'] ?>" readonly>
                                            </div>
                                        </div>
