                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <input type="hidden" class="form-control form-control-sm" id="id_in" name="id_in" required>
                                                <input type="text" class="form-control form-control-sm" id="no_sj" name="no_sj" required autofocus>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date input-group-sm" id="reservationdatetime" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#reservationdatetime" name="date_in" id="date_in" required />
                                        ...
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="input-group date input-group-sm col-5">
                                                <input type="hidden" class="form-control form-control-sm" id="id_po" name="id_po" required>
                                                <input type="text" class="form-control form-control-sm" id="no_po" name="no_po" onclick="cari_po()" required>
                                            </div>
                                        ...
                                        <div class=" form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control form-control-sm" id="supplier_name" name="supplier_name" readonly required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control form-control-sm" id="kurir" name="kurir" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                                            <label for="ekspedisi" class="col-sm-4 col-form-label">Ekspedisi</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control form-control-sm" id="ekspedisi" name="ekspedisi" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                            ...
                            <div class="container mt-5">
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        ...
                                        <a href="<?= base_url('Controller_Warehouse') ?>" class="btn btn-success float-right">Back</a>
...
<script text="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#addRows', function() {
            ...
            htmlRows +=
                ...
                count +
                '" class="form-control form-control-xs " autocomplete="off"  required>  <div class="input-group-append "><div class="input-group-text form-control-xs" onclick="cari_item_c2()"><i class="fa fa-search"></i></div></div> </div></td>';
        ...
        // function heli() {
        //     document.getElementById("item_detail_ok" + count).value = $(this).attr('aaaa');
        // }
    ...
    function cari_item_c2() {
        ...
        //     "ajax": {
        //         url: "<?php echo site_url('Controller_Warehouse/cari_item_po') ?>/" + idx,
        //         type: 'POST'
        //     }
        // });
                        ...
                        <table id="example3" class="table table-hover table-bordered table-sm">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($item as $sm) : ?>
                                    <tr class="pilih_code_c1" data-id="<?= $sm['id_item'] ?>" data-kode="<?= $sm['item_code'] ?>" data-nama="<?= $sm['item_description'] ?>" data-supplier="<?= $sm['supplier_name'] ?>" data-size="<?= $sm['size'] ?>" data-color="<?= $sm['color'] ?>" data-qty="<?= $sm['qty'] ?>">
                                        <th scope="row"><?= $i; ?></th>
                                        <td><?= $sm['item_code']; ?></td>
                    ...
                    <div class="table-responsive">
                        <table id="example2" class="table table-hover table-bordered table-sm">
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                <?php foreach ($item as $sm) : ?>
                                    <tr class="pilih_code_c2" data-id="<?= $sm['id_item'] ?>" data-kode="<?= $sm['item_code'] ?>" data-nama="<?= $sm['item_description'] ?>" data-supplier="<?= $sm['supplier_name'] ?>" data-size="<?= $sm['size'] ?>" data-color="<?= $sm['color'] ?>" data-qty="<?= $sm['qty'] ?>" data-unit="<?= $sm['unit'] ?>">
                                        <th scope=" row"><?= $i; ?></th>
                                        <td><?= $sm['item_code']; ?></td>
                                        <td><?= $sm['item_description']; ?></td>
                                        <td><?= $sm['size']; ?></td>
            ...
            <div class="modal-body">
                <table id="example1" class="table table-bordered table-sm table-hover">
                    ...
                    <tbody>
                        <?php $i = 1; ?>
                        <?php foreach ($po as $m) : ?>
                            <tr class="pilih_suppliers" data-kode="<?= $m['id_po'] ?>" data-po="<?= $m['po_no'] ?>" data-supplier="<?= $m['supplier_name'] ?>">
                                <th scope=" row"><?= $i; ?></th>
                                <td><?= $m['po_no']; ?></td>
