                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control form-control-sm" id="approval" name="approval" value="<?= $po['approval'] ?>" placeholder="Approval Name" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                                            <label for="reservationdatetime" class="col-sm-4 col-form-label">Req
                                                Date</label>
                                            <div class="col-sm-5">
                                                <!-- Date -->
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date input-group-sm" id="reservationdatetime" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#reservationdatetime" name="request_date" value="<?= $po['request_date'] ?>" id="request_date" required />
