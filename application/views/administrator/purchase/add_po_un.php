                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="text-center">
                            <h5 class="font-weight-bold"> PURCHASE MANUAL</h5>
                        </div>
                        <!-- title row -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="hidden" class="form-control form-control-sm" id="id_trim" name="id_trim" required>

                                                <input type="text" class="form-control form-control-sm" id="trim_code" name="trim_code" placeholder="Trim Code" required>
                                            </div>
                                        </div>

                                        <!-- <div class="form-group">

                                            <div class="input-group date input-group-sm" id="reservationdatetime2" data-target-input="nearest">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control form-control-sm" id="approval" name="approval" placeholder="Approval Name" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                                            <label for="reservationdatetime" class="col-sm-4 col-form-label">Req Date</label>
                                            <div class="col-sm-5">
                                                <!-- Date -->
                                                <div class="form-group">

                                                    <div class="input-group date input-group-sm" id="reservationdatetime" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#reservationdatetime" name="request_date" id="request_date" required />
                                        ...
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date input-group-sm" id="reservationdatetime2" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#reservationdatetime2" name="request_in" id="request_in" required />
                                                        <div class="input-group-append" data-target="#reservationdatetime2" data-toggle="datetimepicker">
                                                            <div class="input-group-text"><i class="fa fa-calendar"></i>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control" name="note1" id="note1" rows="2"></textarea>
                        ...
                        <table id="example3" class="table table-hover table-bordered table-sm">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($itemtrim as $sm) : ?>
                                    <tr class="pilih_code_c1" data-id="<?= $sm['id_item'] ?>" data-kode="<?= $sm['item_code'] ?>" data-nama="<?= $sm['item_description'] ?>" data-supplier="<?= $sm['supplier_name'] ?>">
                                        <th scope="row"><?= $i; ?></th>
                                        <td><?= $sm['item_code']; ?></td>
                    ...
                    <div class="table-responsive">
                        <table id="example2" class="table table-hover table-bordered table-sm">
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                <?php foreach ($itemtrim as $sm) : ?>
                                    <tr class="pilih_code_c2" data-id="<?= $sm['id_item'] ?>" data-kode="<?= $sm['item_code'] ?>" data-nama="<?= $sm['item_description'] ?>" data-supplier="<?= $sm['supplier_name'] ?>" data-unit="<?= $sm['unit'] ?>">
                                        <th scope=" row"><?= $i; ?></th>
                                        <td><?= $sm['item_code']; ?></td>
                                        <td><?= $sm['item_description']; ?></td>
                ...
                <table id="example1" class="table table-bordered table-sm table-hover">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($suppliers as $m) : ?>
                            <tr class="pilih_suppliers" data-kode="<?= $m['id_supplier'] ?>" data-nama="<?= $m['supplier_name'] ?>" data-alamat="<?= $m['supplier_address'] ?>" data-remark="<?= $m['remark'] ?>">
                                <th scope=" row"><?= $i; ?></th>
