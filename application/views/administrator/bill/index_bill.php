                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- <a href="<?= base_url('Controller_Bill/add_Bill_un'); ?>" class="btn btn-sm btn-success mb-3">add Bill</a> -->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#example1').DataTable({
            ...
            "ajax": {
                url: '<?php echo site_url('Controller_Bill/get_data_bill') ?>',
                type: 'POST'
            }
    ...
    function detail_data(id) {
        ...
        table = $('#example2').DataTable({
            ...
            "ajax": {
                url: "<?php echo site_url('Controller_Bill/detail_Bill') ?>/" + id,
                type: 'POST'
            }
        });
    ...
    function view_data(id) {
        var a = "<?php echo site_url('Controller_Bill/view_po') ?>/" + id;
        window.location.assign(a);
    }


    function proses_data(id) {
        var a = "<?php echo site_url('Controller_Bill/proses_po') ?>/" + id;
        window.location.assign(a);
    }

    function edit_data(id) {
        var a = "<?php echo site_url('Controller_Bill/edit_po') ?>/" + id;
        window.location.assign(a);
    }
    ...
    function delete_data(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo site_url('Controller_Bill/remove') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
