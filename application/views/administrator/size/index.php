                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <a href="#edit_<?= $m['id_size']; ?>" class="dropdown-item" data-toggle="modal"><span class="fa fa-edit text-primary"></span> Edit</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a href="#delete_<?= $m['id_size']; ?>" class="dropdown-item" data-toggle="modal"><span class="fa fa-trash text-danger"></span> Delete</a>
                                                </div>
                                            </td>
            ...
            <form action="<?= base_url('Controller_Size'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="size_description" name="size_description" placeholder="Size Description">
                    </div>
                </div>
...
<?php foreach ($size as $x) : ?>
    <!-- Delete -->
    <div class="modal fade" id="delete_<?= $x['id_size']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url(); ?>Controller_Size/delete_size/<?= $x['id_size']; ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></span> Yes</a>
                </div>
...
<?php foreach ($size as $xr) : ?>
    <div class="modal fade" id="edit_<?= $xr['id_size']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url('Controller_Size/edit_size/'); ?><?= $xr['id_size']; ?>" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type='hidden' class="form-control" id="id_size" name="id_size" value='<?= $xr['id_size']; ?>' readonly>
                            <?= form_error('id_size', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>

                        <div class="form-group">
                            <label for="menu">size Code</label>
                            <input type="text" class="form-control" id="size_code" name="size_code" value="<?= $xr['size_code']; ?>">
                            <?= form_error('size_code', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="menu">size</label>
                            <input type="text" class="form-control" id="size_description" name="size_description" value="<?= $xr['size_description']; ?>">
