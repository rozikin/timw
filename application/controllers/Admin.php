...
class Admin extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['po'] = $this->db->get('tb_purchase_order')->num_rows();

		$this->db->where('id_trim >', 0);
		$data['trims'] = $this->db->get('tb_trim_order')->num_rows();

		$this->db->where('trim_status', 'Approve');
		$data['Approve'] = $this->db->get('tb_trim_order')->num_rows();


		$this->db->where('trim_status', 'Request');
		$data['Pending'] = $this->db->get('tb_trim_order')->num_rows();
