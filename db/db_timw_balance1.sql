...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2023 at 06:03 AM
...
(1, 'DHL00001', '2/05/2022', 'tomy', 'dhl', '1', 'okay'),
(2, 'DHL00002', '3/05/2022', 'omay', 'jne', '2', 'dhl');
...
(33, '1', '79', 'WHITEPUTIH', 'S', 614, ''),
(34, '1', '79', 'WHITEPUTIH', 'M', 110, ''),
(35, '1', '79', 'WHITEPUTIH', 'L', 110, ''),
(36, '1', '79', 'WHITEPUTIH', 'XL', 218, ''),
(37, '2', '80', '', '', 50, 'ok');
...
(1, 'OUT2022000001', '12/05/2022', 'accessoris', 'cutting', '111', '1111', 'okay'),
(2, 'OUT2022000002', '12/12/2022', 'office', 'office', '-', '-', 'untuk print');
...
(0, '-', 0, '', '', '', '', '', '', '', '', '', '', '', '0', '', '', '0', '', ''),
(1, 'TIMW/0001/PO/2022', 1, '4', '12/05/2022', '12/12/2022', 'warehouse', 'accessoris', 'rita', 'Miyamoto', 'Recived', '5260000', '0', '11', '578600', '5838600', '5838600', 'ok', 'ko', 'rozi@gmail.com'),
(2, 'TIMW/0002/PO/2022', 2, '6', '12/07/2022', '12/14/2022', 'warehouse', 'accessoris', 'rita', 'Miyamoto', 'Recived', '250000', '0', '11', '27500', '277500', '277500', 'sdf', 'sadf', 'rozi@gmail.com');
...
(172, 1, 79, 'WHITEPUTIH', 'S', 614, '5000', '3070000'),
(173, 1, 79, 'WHITEPUTIH', 'M', 110, '5000', '550000'),
(174, 1, 79, 'WHITEPUTIH', 'L', 110, '5000', '550000'),
(175, 1, 79, 'WHITEPUTIH', 'XL', 218, '5000', '1090000'),
(177, 2, 80, '', '', 50, '5000', '250000');
...
(221, '1', 79, 'WHITEPUTIH', 'S', 612, 1, 2, 614, ''),
(222, '1', 79, 'WHITEPUTIH', 'M', 108, 1, 2, 110, ''),
(223, '1', 79, 'WHITEPUTIH', 'L', 108, 1, 2, 110, ''),
(224, '1', 79, 'WHITEPUTIH', 'XL', 216, 1, 2, 218, ''),
...
(0, '-', '', '', '', '', '', '', '', '', ''),
(1, 'T1323-454311-003', '13373N001D', 'P0122-450525-009 (348M)', '350M', '123', 'JAPAN', '12/05/2022', 'Approve', 'ok', 'rozi@gmail.com'),
...
(5, '', '', 'PR/0005/2023', '350M', '1', 'JAPAN', '03/27/2023 3:37 PM', 'Request', 'fgfg', 'rozi@gmail.com');
...
(91, 52, 'Stock', 'Controller_Warehouse/stok', 'far fa-circle', 1),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_balance1`  AS  select `tr`.`id_item` AS `id`,`tr`.`trim_date` AS `dates`,`tr`.`qty` AS `request`,0 AS `purchase`,0 AS `materil_in`,0 AS `material_out`,'tr' AS `ket` from `v_trimorder_fix` `tr` union all select `p`.`id_item` AS `id`,`p`.`request_date` AS `dates`,0 AS `request`,`p`.`qty` AS `purchase`,0 AS `materil_in`,0 AS `material_out`,'p' AS `ket` from `v_purchase_order` `p` union all select `i`.`id_item` AS `id`,`i`.`date_in` AS `dates`,0 AS `request`,0 AS `purchase`,`i`.`qty` AS `materil_in`,0 AS `material_out`,'i' AS `ket` from `v_material_in` `i` union all select `o`.`id_item` AS `id`,`o`.`date_out` AS `dates`,0 AS `request`,0 AS `purchase`,0 AS `materil_in`,`o`.`qty` AS `material_out`,'o' AS `ket` from `v_material_out` `o` ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_balance_det`  AS  select `tr`.`id_item` AS `id`,`tr`.`color` AS `color`,`tr`.`size` AS `size`,`tr`.`trim_date` AS `dates`,`tr`.`qty` AS `request`,0 AS `purchase`,0 AS `materil_in`,0 AS `material_out`,'tr' AS `ket` from `v_trimorder_fix` `tr` union all select `p`.`id_item` AS `id`,`p`.`color` AS `color`,`p`.`size` AS `size`,`p`.`request_date` AS `dates`,0 AS `request`,`p`.`qty` AS `purchase`,0 AS `materil_in`,0 AS `material_out`,'p' AS `ket` from `v_purchase_order` `p` union all select `i`.`id_item` AS `id`,`i`.`color` AS `color`,`i`.`size` AS `size`,`i`.`date_in` AS `dates`,0 AS `request`,0 AS `purchase`,`i`.`qty` AS `materil_in`,0 AS `material_out`,'i' AS `ket` from `v_material_in` `i` union all select `o`.`id_item` AS `id`,`o`.`color` AS `color`,`o`.`size` AS `size`,`o`.`date_out` AS `dates`,0 AS `request`,0 AS `purchase`,0 AS `materil_in`,`o`.`qty` AS `material_out`,'o' AS `ket` from `v_material_out` `o` ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_material_out`  AS  select `tb_material_out`.`id_out` AS `id_out`,`tb_material_out`.`no_out` AS `no_out`,`tb_material_out`.`date` AS `date_out`,`tb_material_out`.`allocation` AS `allocation`,`tb_material_out`.`department` AS `department`,`tb_material_out`.`mo` AS `mo`,`tb_material_out`.`style` AS `style`,`tb_material_out`.`remark` AS `remark`,`v_material_out_detail`.`id_item` AS `id_item`,`v_material_out_detail`.`color` AS `color`,`v_material_out_detail`.`size` AS `size`,`v_material_out_detail`.`item_code` AS `item_code`,`v_material_out_detail`.`unit` AS `unit`,`v_material_out_detail`.`remark` AS `out_remark`,`v_material_out_detail`.`qty` AS `qty` from (`tb_material_out` join `v_material_out_detail` on((`tb_material_out`.`id_out` = `v_material_out_detail`.`id_out`))) ;
...
--
ALTER TABLE `tb_material_in`
  MODIFY `id_in` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tb_material_out`
  MODIFY `id_out` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tb_purchase_order_detail`
  MODIFY `id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=178;
...
--
ALTER TABLE `tb_trim_order`
  MODIFY `id_trim` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
